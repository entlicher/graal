...
public class TestCDTBasics extends AbstractTest {
    ...
    public static void test(WebDriver driver, Consumer<String> output) throws TimeoutException {
        ...
        // The program should finish, pause/resume will be disabled.
        //actions.waitTillEnabled(Action.PAUSE_RESUME, false, TIMEOUT); // The pause/resume action is kept enabled.
